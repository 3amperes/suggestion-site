    ...
    <div className="w-auto text-center text-white">
      <div className="inline-block">
        <svg width="128" viewBox="0 0 128 128">
          <path fill="#f9b785" d="M126 101.5H6.13a59.93 59.93 0 11119.85 0z" />
      ...
      <p>
        Nous trouvons régulièrement des biens, <br /> indiquez-nous ce que vous
        recherchez et vous <br /> aurez ainsi la possibilité de bénéficier de
        nos <br /> futures offres en avant-première.
      </p>
      <p>
        <Link href="/contact">
